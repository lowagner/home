...
#define CRAFT_KEY_CHANGE_COLOR 'C'
#define CRAFT_KEY_OBSERVE 'L'
#define CRAFT_KEY_OBSERVE_INSET 'P'
#define CRAFT_KEY_ITEM_NEXT 'E'
#define CRAFT_KEY_ITEM_PREV 'Q'
#define CRAFT_KEY_REMOVE_BLOCK 'R'
#define CRAFT_WAIT_REMOVE_BLOCK 0.10f
#define CRAFT_KEY_ZOOM GLFW_KEY_LEFT_ALT
#define CRAFT_KEY_ORTHO 'O'
